...
//Timestamp - time.Time supertype created for parsing date values from bittrex v1.1 and v2.0 json payloads.
type Timestamp time.Time

//UnmarshalJSON implement json.Unmarshaler interface
func (bt *Timestamp) UnmarshalJSON(raw []byte) error {
	...
	*bt = Timestamp(parsedTime)
	return nil
}

//String implement stringer interface
func (bt *Timestamp) String() string {
	cast := time.Time(*bt)
	return cast.Format("2006-01-02T03:04:05")
}

//Time cast Timestamp back to time.Time
func (bt *Timestamp) Time() time.Time {
	return time.Time(*bt)
}
...
type MarketSummary struct {
	...
	TimeStamp         Timestamp `json:"TimeStamp"`         // : "2014-07-09T07:19:30.15",
	...
	Created           Timestamp `json:"Created"`           // : "2014-03-20T06:00:00",
...
type Trade struct {
	...
	TimeStamp Timestamp `json:"TimeStamp"` // : "2014-07-09T03:21:20.08",
...
type OrderDescription struct {
	...
	Opened            Timestamp `json:"Opened"`            // : "2014-07-09T03:55:48.77",
	Closed            Timestamp `json:"Closed"`            // : null,
...
type AccountOrderDescription struct {
	...
	Price                      decimal   `json:"Price"`                      // : 0.00000000,
	PricePerUnit               decimal   `json:"PricePerUnit"`               // : null,
	Opened                     Timestamp `json:"Opened"`                     // : "2014-07-13T07:45:46.27",
	Closed                     Timestamp `json:"Closed"`                     // : null,
...
type AccountOrderHistoryDescription struct {
	...
	Exchange          string    `json:"Exchange"`          // : "BTC-LTC",
	TimeStamp         Timestamp `json:"TimeStamp"`         // : "2014-07-09T04:01:00.667",
...
type TransactionHistoryDescription struct {
	...
	Opened         Timestamp `json:"Opened"`         // : "2014-07-09T04:24:47.217",
