//all credit for this file goes to github.com/zoh
...
//Transport struct containing transport information to use with http client.
type Transport struct {
	upstream http.RoundTripper
	cookies  http.CookieJar
}

//NewTransport constructor for Transport object.
...
func (t Transport) RoundTrip(r *http.Request) (*http.Response, error) {
	...
	if resp.StatusCode == 503 && (serverName == "cloudflare-nginx" || serverName == "cloudflare") {
